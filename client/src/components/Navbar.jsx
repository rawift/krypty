...
const [toggleMenu, setToggleMenu] = useState(false)
    ...
    return(
      <nav className="w-full flex md:justify-center justify-between items-center p-4">
        <div className='md:flex-[0.5] flex-intial justify-centre items-center'>
            <img src={logo} alt="logo" className="w-32 cursor-pointer"></img>
        </div>
        <ul className="text-white md:flex hidden list-none flex-row justify-between items-center flex-intital">
{arr.map((item, index)=>(
